...
![An overview of a polished andesite tower](/img/guides/cuboid-overview.png)

First, we stand very close to one **corner** of the region and note the coordinates are `(32, 60, -20)`:

![](/img/guides/cuboid-c1.png)
...
![The topdown view of a cylinder region with a highlight showing a radius of 5 blocks](/img/guides/cylinder-overview.png)
