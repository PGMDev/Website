...
<div className="text--center">
  <ImageSwitcher alt="A screenshot of a sample map folder. It shows the following files in order: 'level.dat', 'map.png', 'map.xml', and a folder titled 'region'."
...
<div className="text--center row">
  <div className="col">
    <img src="/img/guides/totally-war-2.png" alt="Totally War 2" title="Totally War 2"/>
  </div>
  <div className="col">
    <img src="/img/guides/rage-quit.png" alt="Rage Quit" title="Rage Quit"/>
  </div>
</div>
...
- **Windows 10 and older:** Right Click > Send To > Compressed (zipped) Folder
...
You can also upload your map's XML file to [GitHub Gist](https://gist.github.com/), [Pastebin](https://pastebin.com/), or one of the many alternatives available online.
