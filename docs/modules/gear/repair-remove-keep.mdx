...
Repairing arrows instead of removing them has the advantage of the player being able to accidental drop one and not lose it.
...
If there is a spawn kit, kept items will be given back _after_ the kit is applied, except for equipped armor, which will replace any armor in the kit.
