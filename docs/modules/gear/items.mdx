  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>
          Prevent this armor item from being removed from the armor slot in any way.
        </td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
...
For more details on the `<effect>` element, visit [Potion Effects](/docs/modules/gear/potions). Additionally, you can visit [Potions & Effects](/docs/reference/items/potions) for references on potion effects available in Minecraft.
...
Written books can be created using the book element. The title, author, and individual pages can be formatted with [formatting codes](/docs/reference/misc/formatting).
...
<div className="table-container">
  <table>
    ...
    <tbody>
      <tr>
        <td>
          <label>{`<firework> </firework>`}</label>
        </td>
        <td>A firework design containing one or more explosion effect.</td>
      </tr>
      <tr>
        <th>Sub-elements</th>
        <th />
      ...
      <tr>
        <td>
          <label>{`<explosion> </explosion>`}</label>
        </td>
        <td>
          Define an explosion effect design.
        </td>
      </tr>
    </tbody>
  </table>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>
          Defines the power of the firework.
          This also determines how high it will travel.
        </td>
        <td>
          <span className="badge badge--primary">Number</span>
        </td>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>
          Define the type of explosion effect.
        </td>
        <td>
          <label>ball</label>,
          <label>ball large</label>, <br />
          <label>burst</label>,
          <label>creeper</label>,
          <label>star</label>
        </td>
      ...
      <tr>
        ...
        <td>
          Whether the effect should flicker.
        </td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
      ...
      <tr>
        ...
        <td>
          Whether the effect should have a trail.
        </td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>
          <span className="badge badge--danger">Required</span>
          Define a color of the firework.
        </td>
        <td>
          <a href="/docs/reference/misc/colors">Hex Firework Color</a>
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          Define a fade color of the firework. Multiple fade colors can be defined for each explosion. 
          <br />
          <em>
