...
The `team-color` attribute can be used to attribute color to leather armor automatically.
This helps to simplfy kits so a seperate team kit for only colored armor is not required.
