...
|---|---|---|---|
| `display` | Set how score should appear in the scoreboard.<br />**Note:** In maps without a mercy rule or score limit, only earned points are shown. | `numerical`, `circle`, `square`, `heart`, `pipe` | `numerical` |
...
| `heart` - displays as `❤` heart in the scoreboard, visible up to score/limit of 10. | ![](/img/modules/score-display-heart.png) |
