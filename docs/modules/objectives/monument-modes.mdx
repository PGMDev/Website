...
<div className="table-container">
  ...
  | `material` | <span className="badge badge--danger">Required</span>The material the core/destroyable will change to. | [Single Material Pattern](/docs/reference/items/inventory#material_matchers) |
