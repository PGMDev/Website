  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          The rate for a control point to recover to its current state.
          Applies when the owning team is dominating (only having players of the capturing team on the point).
        </td>
        <td>
          <span className="badge badge--primary">Number</span>
        </td>
      ...
      <tr>
        ...
        <td>
          The rate for a control point to decay to its current state.
          Applies when nobody is dominating the point (contested by multiple teams or no teams on the point).
          Can be determined by <label>capture-rules</label>.
        </td>
        <td>
          <span className="badge badge--primary">Number</span>
        </td>
