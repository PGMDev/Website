  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Broadcast messages related to the wool in chat.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td>true</td>
      ...
      <tr>
        ...
        <td>Play sounds, fireworks and other effects related to the wool.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td>true</td>
      ...
      <tr>
        ...
        <td>
          Display the wool under commands such as <label>/match</label>.
        </td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
      ...
      <tr>
        ...
        <td>Displays the wool on scoreboard.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td>true</td>
      ...
      <tr>
        ...
        <td>Determines if this wool counts as a win condition.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td>true</td>
      ...
      <tr>
        ...
        <td>
          Specify if the wool should be hidden from all visible locations to the
