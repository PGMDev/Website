...
<div className="table-container">
  ...
  | `materials` | The destroyable's materials, multiple materials are separated with a semicolon `;`. | [Material Pattern](/docs/reference/items/inventory#material_matchers) |
