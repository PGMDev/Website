...
<div className="table-container">
  ...
  | `material` | The core casing material, used to detect breaks, and for mode changes. | [Single Material Pattern](/docs/reference/items/inventory#material_matchers) | `obsidian` |
