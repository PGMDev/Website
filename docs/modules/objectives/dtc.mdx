  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          Instead of a touch, a % representing how far the core has been leaked
          is shown. This works similar to destroyables.
        </td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
      ...
      <tr>
        ...
        <td>Broadcast messages related to the core in chat.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td>true</td>
      ...
      <tr>
        ...
        <td>Play sounds, fireworks and other effects related to the core.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td>true</td>
      ...
      <tr>
        ...
        <td>
          Display the core under commands such as <label>/match</label>.
        </td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
      ...
      <tr>
        ...
        <td>Displays the core on scoreboard.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td>true</td>
      ...
      <tr>
        ...
        <td>Determines if this core counts as a win condition.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td>true</td>
