...
id: introduction
title: Introduction
description: PGM originally started in 2012 as a single game plugin specifically built to run one map.
---
...
PGM reads `map.xml` when the server is loaded, and when the match starts it applies all the functions that are defined in the XML file onto the game.
