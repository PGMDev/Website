...
| `name-tags-allies-filter` | Filter who can see allied players' name tags.<br />**Note:** This cannot be used with `show-name-tags`. | [Filter](/docs/modules/mechanics/filters) | `always` |
| `name-tags-enemies-filter` | Filter who can see enemy players' name tags.<br />**Note:** This cannot be used with `show-name-tags`. | [Filter](/docs/modules/mechanics/filters) | `always` |
