...
| `name-tags-filter` | Filter who can see other players' name tags.<br />**Note:** This cannot be used with `show-name-tags`. | [Filter](/docs/modules/mechanics/filters) | `always` |
