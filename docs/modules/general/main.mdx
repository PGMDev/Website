...
This tool allows them to avoid the need to duplicate existing maps and, instead, simplify various versions into one location.
...
:::note
Constants are not necessarily tied to variants, you can use constants throughout the map XML without variants. It can also be used for includes.
:::
