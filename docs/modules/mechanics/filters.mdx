    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <br/><em>Must be longer than period.</em>
        </td>
        <td>
          <a href="/docs/reference/misc/time-periods">Time Period</a>
        </td>
...
Coordinates relative to the player are defined using `~`, and behave the same like
`~` does in-game.
...
:::caution
`<objective>` is depricated and may be removed in future versions of PGM.
...
:::caution
This filter is very computationally
