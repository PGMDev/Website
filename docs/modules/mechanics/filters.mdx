...
| Attribute | Description | Value |
|---|---|---|
| `period` | <span className="badge badge--danger">Required</span>Length of time a cycle lasts for. | [Time Period](/docs/reference/misc/time-periods) |
...
either using exact coordinate vectors, coordinates relative to the player,
