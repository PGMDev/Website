...
<div className="table-container">
  | Element | Description |
  |---|---|
  | `<material>block</material>` | Matches blocks by their [Material](/docs/reference/items/inventory#material_finder) name.<br />Accepts a [Single Material Pattern](/docs/reference/items/inventory#material_matchers). |
...
<div className="table-container">
  ...
  | `message` | Optional timer message to display while counting down. Only players who match the filter can see the timer. If the message contains a placeholder, it will be replaced with the remaining time. | <span className="badge badge--primary">String</span> |
</div>
...
<div className="table-container">
  ...
  | `message` | Optional message to display after the child filter allows. Only players who match the filter can see the message. If the message contains a placeholder, it will be replaced with the remaining time. | <span className="badge badge--primary">String</span> |
</div>
