...
The filter activates and deactiviates for a certain duration in a time peroid, after
...
```
<filters>
  <!-- Pulses activation for 15 seconds after matching, then turns off for another 15 seconds, etc -->
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Matches if the team of the player is the one that completed it.</td>
        <td>Objective ID</td>
      </tr>
    </tbody>
  </table>
