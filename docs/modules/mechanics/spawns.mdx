...
<div className="table-container">
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>
          <label>spread-teammates</label>
        </td>
        <td>Spawn teammates as far away as possible from each other.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td>false</td>
...
The respawn module allows the map creator to adjust the respawn time and if players are automatically respawned. For maps that may require instant respawn, you can set the delay to `0s`.
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>Node specifying the default respawn settings for this map.</td>
      </tr>
      <tr>
        <td>
          <label>{`<respawns>`}</label>
        </td>
        <td>Node specifying multiple respawn options for this map.</td>
      </tr>
    </tbody>
  </table>
</div>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Filters when the respawn is used.</td>
        <td>
          <a href="/docs/modules/mechanics/filters">Filter</a>
        </td>
        <td></td>
